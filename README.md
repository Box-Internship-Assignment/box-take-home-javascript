...
You can work on this project locally on your desktop or online on Repl.it. **No matter what option you choose, please ensure you are using Node `12.16.1` when developing your code, and your code runs on [Repl.it](#working-on-repl-beta) as we will be using it for the code walkthrough**
